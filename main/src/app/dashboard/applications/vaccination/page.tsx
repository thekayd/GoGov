...
import {
  createVaccinationApplicationModel,
  VaccinationApplicationFormSchema,
  VaccinationApplicationFormTemplate,
...
export default function VaccinationApplicationPage() {
  return (
    <main className="mx-auto mt-3">
      <div className="mb-8 mt-10 flex flex-col items-center justify-center text-center">
        <h1 className=" text-4xl font-bold">Vaccination Applications</h1>
        <p className=" text-gray-600">
          Apply for your vaccination online.
          <br />
        ...
        <Card className="h-fit w-full max-w-4xl">
          ...
          <CardContent className="">
            <ApplicationFormProvider
              table_name="vaccination_applications"
              createApplicationModel={createVaccinationApplicationModel}
              modelFormSchema={VaccinationApplicationFormSchema}
            >
              <ApplicationForm template={VaccinationApplicationFormTemplate} />
            </ApplicationFormProvider>
          </CardContent>
        </Card>
