  ...
  return (
    <main className="mx-auto mt-3">
      <div className="mb-8 flex flex-col items-center justify-center text-center">
        <h1 className=" text-4xl font-bold">Feedback Applications</h1>
        <p className=" text-gray-600">
          Apply for your Feedback online.
          <br />
        ...
        <Card className="h-fit w-full ">
          ...
          <CardContent className="">
            <ApplicationFormProvider
              ...
              createApplicationModel={createFeedbackModel}
              modelFormSchema={FeedbackFormSchema}
            >
              <ApplicationForm template={FeedbackFormTemplate} />
            </ApplicationFormProvider>
          </CardContent>
        </Card>
      </div>
